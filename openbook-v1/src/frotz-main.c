...
int cdecl df_main (int argc, char *argv[])
{

    os_process_arguments (argc, argv);
    vis_debug('f', "Arguments processed.");

    init_memory ();
    vis_debug('f', "Memory initialised.");

    os_init_screen ();
    vis_debug('f', "Internal screen initialised.");

    init_undo ();
    vis_debug('f', "Undo ready.");

    z_restart ();
    vis_debug('f', "Z Machine reset.");

    interpret ();
    vis_debug('f', "Game interpreted.");

    reset_memory ();
    vis_debug('f', "Memory reset.");

    os_reset_screen ();
    vis_debug('f', "Screen reset.");
